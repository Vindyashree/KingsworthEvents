...
export default function SimplePaper() {
  ...
  return (
    <div  style = {{padding:"50px",fontSize:"2vw",alignItems:"center",backgroundColor:"palegreen"}}>
<Paper elevation={0} >
<LogoImage />
<br></br>
<br></br>
  <span style={{fontFamily: "Lucida Handwriting"}}>
  Make your dreams worthier
we are kingsworth events , we do serve all kinds of events like wedding, private parties, birthday parties ,house warming and many more with the best accessories and with the best execution.
  </span>
